...
export class MBServer {
  ...
  private routes() {
    ...
    router.get('/', function (req:any, res:any) {
      ...
      this.dal.getRecords(budget.cOK, budget.cKO, budget.pBad, priceRange, budget.maxItems, function(err:any, items:any[]) {
  ...
  loadItemMainProps() {
    ...
    this.dal.getHeads([], ["sku","category","price","description"], true, 0, function(err:any, items:any[]) {      
        ...
        srv.createCompatibilityMatrix(srv.itemsMainProps);
    });
  } // loadItemMainProps

  public itemCM:any = {};
  public createCompatibilityMatrix(itemsMainProps:any[]) {
    let stime = Date.now();
  ...
  public isSimilar(prop:any, item1:any, item2:any):boolean {
    ...
    try{
      ...
      console.log('sim:',n1,n2);
      
      if (!(isNaN(n1) || isNaN(n2))){
        console.log("res:",(n1 >= (n2 *.95) && n1 <= (n2 * 1.05)));
